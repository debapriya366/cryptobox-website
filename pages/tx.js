...
export default function Tx() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.covalenthq.com/v1/${NETWORK_ID}/address/${ADDRESS}/transactions_v2/?quote-currency=USD&format=JSON&block-signed-at-asc=false&no-logs=false&key=cqt_rQFKCccXvv8VmwFGgM6B6GHBKgDW`
      )
      .then((response) => {
